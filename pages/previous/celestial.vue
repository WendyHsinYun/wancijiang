  ...
  template(v-slot:customContent)
    v-col.text-center.d-flex.flex-column(cols="12")
      v-img(
        ...
        cover)
      em.my-2.font-weight-thin.text-medium-emphasis {{ t('caption1') }}

    v-col(cols='auto').my-2
      div(v-html='formattedContent1')
    ...
    v-col.text-center.d-flex.flex-column(cols="12")
      v-img(
        ...
        class="bg-grey-lighten-2"
        cover)
      em.my-2.font-weight-thin.text-medium-emphasis {{ t('caption2') }}
    ...
    v-col.text-center.d-flex.flex-column(cols="12")
      v-img(
        ...
        class="bg-grey-lighten-2"
        cover)
      em.my-2.font-weight-thin.text-medium-emphasis {{ t('caption3') }}

    v-col(cols='auto').my-2
      div(v-html='formattedContent4')    
    ...
    v-col.text-center.d-flex.flex-column(cols="12")
      v-img(
        ...
        class="bg-grey-lighten-2"
        cover)
      em.my-2.font-weight-thin.text-medium-emphasis {{ t('caption4') }}

    v-col(cols='auto').my-2
      div(v-html='formattedContent5')  
    ...
    v-col(cols='auto').my-2
      div(v-html='formattedContent6')  

    v-col(cols='auto').my-2
      h3 {{ t('subTitle2') }}

    v-col(cols='auto').my-2
      div(v-html='formattedContent7')  
  
    v-col(cols='auto').my-2
      h3 {{ t('subTitle3') }}

    v-col(cols='auto').my-2
      div(v-html='formattedContent8')  
    ...
    v-col.text-center.d-flex.flex-column(cols="12")
      v-img(
        ...
        class="bg-grey-lighten-2"
        cover)
      em.my-2.font-weight-thin.text-medium-emphasis {{ t('caption5') }}  

    v-col(cols='auto').my-2
      div(v-html='formattedContent9')  

    v-col(cols='auto').my-2
      a(target="_blank" href="https://opinion.cw.com.tw/blog/profile/52/article/7647") {{ t('link') }}
</template>
